...
wget https://raw.githubusercontent.com/ggghju/kcp/master/start.bat
wget https://raw.githubusercontent.com/ggghju/kcp/master/stop.bat
...
wget https://raw.githubusercontent.com/ggghju/kcp/master/speederv2_amd64
wget https://raw.githubusercontent.com/ggghju/kcp/master/server_linux_amd64
chmod +x speederv2 server_linux_amd64
...
#启动服务
nohup ./speederv2 -s -l0.0.0.0:$udpspeederport -r127.0.0.1:$port -k "atrandys" -f2:4 --mode 0 -q1 >speeder.log 2>&1 &
